...
if (isset($_POST['nama_pelanggan'])) {
    ...
    // jalankan query
    $query = "UPDATE pelanggan SET nama_pelanggan = '$nama_pelanggan', alamat = '$alamat', nomor_telepon = '$nomor_telepon' WHERE pelanggan_id = $pelanggan_id";

    // Fungsi $update_hasil adalah untuk melakukan eksekusi query yang ada pada $query.
    $eksekusi_query = $konek_db->query($query);
}

$query_tampilkan =$konek_db->query("SELECT * FROM pelanggan where pelanggan_id = $pelanggan_id");
