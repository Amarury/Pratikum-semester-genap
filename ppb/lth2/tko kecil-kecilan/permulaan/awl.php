...
$konek_db = new mysqli("localhost", "root", "", "preview");
...
if (isset($_POST['submit'])) {
    ...
    $result = $konek_db -> query("SELECT * FROM petugas WHERE username='$username'LIMIT 1");
...
<head>
    ...
    <link rel="stylesheet" href="../assets/lgin.css">
