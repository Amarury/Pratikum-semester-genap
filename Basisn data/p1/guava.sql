...
--4
SELECT COUNT(jenis_kelamin) AS jumlah_karyawan FROM karyawan WHERE jenis_kelamin = 'L';
...
FROM gaji
JOIN karyawan
ON gaji.id_karyawan = karyawan.id_karyawan
JOIN absensi 
...
--8
SELECT COUNT(nama) as jumlah_karyawan FROM karyawan GROUP BY jenis_kelamin;
